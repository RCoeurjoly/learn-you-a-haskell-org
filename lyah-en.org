#+TODO: TODO_NEXT(n) TODO(t) WAIT(w!) | DONE(d) CANCELED(c)
[[file:media/lyah.jpg]]

* TODO Learn You a Haskell for Great Good! [2%]
  :PROPERTIES:
...
** DONE Introduction
 ...
 <<ch001.xhtml#about-this-tutorial>>
*** About this tutorial
 ...
 <<ch001.xhtml#so-whats-haskell>>
*** So what's Haskell?

 [[file:media/file1.png]] Haskell is a /purely functional programming
 ...
 [[file:media/file2.png]] Haskell is /lazy/. That means that unless
 ...
 [[file:media/file3.png]] Haskell is /statically typed/. When you compile
 ...
 <<ch001.xhtml#what-you-need-to-dive-in>>
*** What you need to dive in
 ...
 <<ch002.xhtml#starting-out>>
** TODO_NEXT Starting Out
*** DONE Ready, set, go!
    CLOSED: [2020-04-28 Tue 19:31]

 [[file:media/file4.png]] Alright, let's get started! If you're the sort
...
5 == True
 ...
 [[file:media/file5.png]] Functions are usually prefix so from now on we
...
(succ 9) + (max 5 4) + 1
 ...
 <<ch002.xhtml#babys-first-functions>>
...
doubleMe 8
 ...
 <<ch002.xhtml#an-intro-to-lists>>
*** TODO An intro to lists

 [[file:media/file7.png]] Much like shopping lists in the real world,
 ...
 <<ch002.xhtml#texas-ranges>>
*** TODO Texas ranges

 [[file:media/file9.png]] What if we want a list of all numbers between 1
...
replicate 3 10
 ...
 <<ch002.xhtml#im-a-list-comprehension>>

 <<ch002.xhtml#im-a-list-comprehension>>
*** TODO I'm a list comprehension

 [[file:media/file10.png]] If you've ever taken a course in mathematics,
 ...
 [[file:media/file11.png]]. The part before the pipe is called the output
...
*** TODO Tuples
 ...
 <<ch003.xhtml#types-and-typeclasses>>
** TODO Types and Typeclasses
*** TODO Believe the type

 #+CAPTION: moo
 [[file:media/file14.png]]
 ...
 [[file:media/file15.png]] Here we see that doing =:t= on an expression
...
*** TODO Type variables
 ...
 [[file:media/file16.png]] Hmmm! What is this =a=? Is it a type? Remember
 ...
 <<ch003.xhtml#typeclasses-101>>

 <<ch003.xhtml#typeclasses-101>>
*** TODO Typeclasses 101

 #+CAPTION: class
 [[file:media/file17.png]]
 ...
 <<ch004.xhtml#syntax-in-functions>>
** TODO Syntax in Functions
*** TODO Pattern matching

 #+CAPTION: four!
 [[file:media/file18.png]]
 ...
 <<ch004.xhtml#guards-guards>>

 <<ch004.xhtml#guards-guards>>
*** TODO Guards, guards!

 #+CAPTION: guards
 [[file:media/file19.png]]
...
*** TODO Let it be
 ...
 <<ch004.xhtml#case-expressions>>
*** TODO Case expressions

 #+CAPTION: case
 [[file:media/file21.png]]
 ...
 <<ch005.xhtml#recursion>>
** TODO Recursion
*** TODO Hello recursion!

 #+CAPTION: SOVIET RUSSIA
 [[file:media/file22.png]]
...
*** TODO Maximum awesome
 ...
 #+CAPTION: max
 [[file:media/file23.png]]

 <<ch005.xhtml#a-few-more-recursive-functions>>
...
*** TODO Quick, sort!
 ...
 <<ch005.xhtml#thinking-recursively>>
*** TODO Thinking recursively
 ...
 <<ch006.xhtml#higher-order-functions>>
** TODO Higher order functions

 #+CAPTION: sun
 [[file:media/file28.png]]
...
*** TODO Curried functions
 ...
 <<ch006.xhtml#some-higher-orderism-is-in-order>>
...
*** TODO Lambdas
 ...
 <<ch006.xhtml#only-folds-and-horses>>
*** TODO Only folds and horses

 #+CAPTION: folded bird
 [[file:media/file34.png]]
 ...
 <<ch006.xhtml#function-application-with>>
*** TODO Function application with $
 ...
 <<ch006.xhtml#composition>>

 <<ch006.xhtml#function-composition>>
*** TODO Function composition

 In mathematics, function composition is defined like this:
 [[file:media/file38.png]], meaning that composing two functions produces
...
*** TODO Data.List
 ...
 <<ch007.xhtml#data.char>>
*** TODO Data.Char

 #+CAPTION: lego char
 [[file:media/file42.png]]
...
*** TODO Data.Map
 ...
 <<ch007.xhtml#data.set>>
*** TODO Data.Set

 #+CAPTION: legosets
 [[file:media/file44.png]]
 ...
 <<ch007.xhtml#making-our-own-modules>>
*** TODO Making our own modules

 #+CAPTION: making modules
 [[file:media/file45.png]]
 ...
 <<ch008.xhtml#making-our-own-types-and-typeclasses>>
...
*** TODO Algebraic data types intro
 ...
 <<ch008.xhtml#record-syntax>>
*** TODO Record syntax

 #+CAPTION: record
 [[file:media/file47.png]]
...
*** TODO Type parameters
 ...
 <<ch008.xhtml#derived-instances>>
*** TODO Derived instances

 #+CAPTION: gob
 [[file:media/file50.png]]
...
*** TODO Type synonyms
 ...
 <<ch008.xhtml#recursive-data-structures>>

 <<ch008.xhtml#recursive-data-structures>>
*** TODO Recursive data structures

 #+CAPTION: the fonz
 [[file:media/file52.png]]
 ...
 <<ch008.xhtml#typeclasses-102>>
*** TODO Typeclasses 102

 #+CAPTION: tweet
 [[file:media/file54.png]]
 ...
 <<ch008.xhtml#a-yes-no-typeclass>>
*** TODO A yes-no typeclass

 #+CAPTION: yesno
 [[file:media/file55.png]]
 ...
 <<ch008.xhtml#the-functor-typeclass>>
...
*** TODO The Functor typeclass
 ...
 <<ch008.xhtml#kinds-and-some-type-foo>>
*** TODO Kinds and some type-foo

 #+CAPTION: TYPE FOO MASTER
 [[file:media/file57.png]]
 ...
 <<ch009.xhtml#input-and-output>>
** TODO Input and Output

 #+CAPTION: poor dog
 [[file:media/file58.png]]
...
*** TODO Hello, world!
 ...
 <<ch009.xhtml#files-and-streams>>
*** TODO Files and streams

 #+CAPTION: streams
 [[file:media/file61.png]]
 ...
 <<ch009.xhtml#command-line-arguments>>
*** TODO Command line arguments

 #+CAPTION: COMMAND LINE ARGUMENTS!!! ARGH
 [[file:media/file64.png]]
...
*** TODO Bytestrings
 ...
 <<ch009.xhtml#exceptions>>
*** TODO Exceptions

 #+CAPTION: timberr!!!!
 [[file:media/file69.png]]
 ...
 <<ch010.xhtml#functionally-solving-problems>>
...
*** TODO Reverse Polish notation calculator
 ...
 [[http://en.wikipedia.org/wiki/Reverse_Polish_notation][Reverse Polish
 notation]] is another way of writing down mathematical expressions.
 ...
 <<ch010.xhtml#heathrow-to-london>>
*** TODO Heathrow to London
 ...
 <<ch011.xhtml#functors-applicative-functors-and-monoids>>
...
*** TODO Applicative functors
 ...
 <<ch011.xhtml#the-newtype-keyword>>
*** TODO The newtype keyword

 #+CAPTION: why\_ so serious?
 [[file:media/file85.png]]
 ...
 <<ch011.xhtml#using-newtype-to-make-type-class-instances>>
**** Using newtype to make type class instances
 ...
 <<ch011.xhtml#on-newtype-laziness>>
**** On newtype laziness
 ...
 <<ch011.xhtml#type-vs.-newtype-vs.-data>>
...
**** =Any= and =All=
 ...
 <<ch011.xhtml#the-ordering-monoid>>
**** The =Ordering= monoid
...
**** =Maybe= the monoid
 ...
 <<ch011.xhtml#using-monoids-to-fold-data-structures>>
**** Using monoids to fold data structures
 ...
 <<ch012.xhtml#a-fistful-of-monads>>
 ...
 *If we have a fancy value and a function that takes a normal value but
 ...
 <<ch012.xhtml#getting-our-feet-wet-with-maybe>>
*** TODO Getting our feet wet with Maybe

 #+CAPTION: monads, grasshoppa
 [[file:media/file94.png]]
 ...
 <<ch012.xhtml#the-monad-type-class>>
*** TODO The Monad type class
 ...
 <<ch012.xhtml#walk-the-line>>

 <<ch012.xhtml#walk-the-line>>
*** TODO Walk the line

 #+CAPTION: pierre
 [[file:media/file97.png]]
...
*** TODO do notation
 ...
 <<ch012.xhtml#the-list-monad>>

 <<ch012.xhtml#the-list-monad>>
*** TODO The list monad

 #+CAPTION: dead cat
 [[file:media/file101.png]]
...
**** Associativity
 ...
 <<ch013.xhtml#for-a-few-monads-more>>
** TODO For a Few Monads More
 ...
 <<ch013.xhtml#writer-i-hardly-know-her>>
*** TODO Writer? I hardly know her!
 ...
 <<ch013.xhtml#monoids-to-the-rescue>>
...
**** The =Writer= type
 ...
 <<ch013.xhtml#using-do-notation-with-writer>>
**** Using do notation with Writer
 ...
 <<ch013.xhtml#adding-logging-to-programs>>
**** Adding logging to programs
 ...
 <<ch013.xhtml#inefficient-list-construction>>
**** Inefficient list construction
 ...
 <<ch013.xhtml#difference-lists>>
**** Difference lists

 #+CAPTION: cactuses
 [[file:media/file108.png]]
 ...
 <<ch013.xhtml#comparing-performance>>
**** Comparing Performance
 ...
 <<ch013.xhtml#reader-ugh-not-this-joke-again.>>
*** TODO Reader? Ugh, not this joke again.

 #+CAPTION: bang youre dead
 [[file:media/file109.png]]
 ...
 <<ch013.xhtml#tasteful-stateful-computations>>
*** TODO Tasteful stateful computations

 #+CAPTION: don't jest with texas
 [[file:media/file110.png]]
...
**** The State monad
 ...
 <<ch013.xhtml#randomness-and-the-state-monad>>
**** Randomness and the state monad
 ...
 <<ch013.xhtml#error-error-on-the-wall>>
*** TODO Error error on the wall
 ...
 <<ch013.xhtml#some-useful-monadic-functions>>
*** TODO Some useful monadic functions
 ...
 <<ch013.xhtml#liftm-and-friends>>
**** liftM and friends

 #+CAPTION: im a cop too
 [[file:media/file112.png]]
...
**** foldM
 ...
 <<ch013.xhtml#making-a-safe-rpn-calculator>>
**** Making a safe RPN calculator

 #+CAPTION: i've found yellow!
 [[file:media/file114.png]]
 ...
 <<ch013.xhtml#composing-monadic-functions>>
**** Composing monadic functions
 ...
 <<ch013.xhtml#making-monads>>
*** TODO Making monads

 #+CAPTION: kewl
 [[file:media/file115.png]]
...
*** TODO Taking a walk
 ...
 <<ch014.xhtml#a-trail-of-breadcrumbs>>
*** TODO A trail of breadcrumbs

 #+CAPTION: whoop dee doo
 [[file:media/file120.png]]
...
**** Going back up
 ...
 <<ch014.xhtml#manipulating-trees-under-focus>>
**** Manipulating trees under focus
 ...
 <<ch014.xhtml#im-going-straight-to-the-top-oh-yeah-up-where-the-air-is-fresh-and-clean>>
...
*** TODO Focusing on lists
 ...
 <<ch014.xhtml#a-very-simple-file-system>>
*** TODO A very simple file system
 ...
 <<ch014.xhtml#a-zipper-for-our-file-system>>
**** A zipper for our file system

 #+CAPTION: spongedisk
 [[file:media/file124.png]]
 ...
 <<ch014.xhtml#manipulating-our-file-system>>
